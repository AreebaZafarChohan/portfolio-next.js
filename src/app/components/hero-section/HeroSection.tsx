  ...
  return (
    ...
    />
          ...
          <p className="lg:text-lg text-base sm:text-lg mb-6">
            a passionate front-end web developer. I've honed my skills in a
            ...
            websites that provide a great user experience. Whether it's coding
            up a new feature or optimizing performance, I'm always eager to take
